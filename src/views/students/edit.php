<h1 class="text-center">Изменить информацию о себе</h1>
<form role="form" action="add" method='POST'>
    ...
    <select name="gender" class="form-control" required>        
        <option value="male" <?=$params['values']['local']==0 ? 'selected="selected"' : ''?>>Мужской</option>
        <option value="female" <?=$params['values']['local']==1 ? 'selected="selected"' : ''?>>Женский</option>
    </select>
    <br/>
    <div class="form-group">
    ...
    <label for="local">Место жительства</label>
    <select name="local" class="form-control" required >        
        <option value="local" <?=$params['values']['local']==0 ? 'selected="selected"' : ''?>>Местный</option>
        <option value="foreign" <?=$params['values']['local']==1 ? 'selected="selected"' : ''?>>Иногородний</option>
    </select>
    <br/>
